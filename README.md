...
| 시스템 이름          | 기능                                 | 학습목표                       | 특징                                            | 개념 설명 링크                                              |
|----------------------|---------------------------------------|------------------------------|------------------------------------------------|------------------------------------------------------------|
| 계산기                | 사칙연산, 원의 둘레 계산를        |                                    | 간단한 사용법, 다양한 계산 기능 제공          | [계산기 개념](https://github.com/dami0806/SpartaAssignment/blob/main/README.md#%EA%B3%84%EC%82%B0%EA%B8%B0)       |
| 학생관리시스템    | 학생 정보 관리, 성적 관리, 출결 관리 |                             | 다양한 사용자 권한 설정, 실시간 업데이트 등 | [학생관리시스템 개념](https://github.com/dami0806/SpartaAssignment?tab=readme-ov-file#2-student-management-system) |
